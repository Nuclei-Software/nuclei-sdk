...
#else
#define TX_THREAD_SMP_MAX_CORES                 SMP_CPU_CNT
#endif
#endif
...
#else
#define TX_THREAD_SMP_CORE_MASK                 ((1 << SMP_CPU_CNT) - 1)
#endif
#endif
...
static inline UINT  _tx_thread_smp_core_get(void)
{
    return (UINT)__get_hart_index();
}
...
CHAR                            _tx_version_id[] =
                                    "Copyright (c) Microsoft Corporation. All rights reserved. * ThreadX Nuclei RISC-V SMP Version 6.4.0 *";
#else
