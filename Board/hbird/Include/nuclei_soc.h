...
#include "system_nuclei_soc.h"                    /*!< nuclei_soc System */
...
#define NUCLEI_SOC_PERIPH_BASE                (0x10000000UL)      /*!< (Peripheral) Base Address */

/* Peripheral memory map */
/* Fast-IO Interfaced IP */
#define GPIO_BASE         (NUCLEI_SOC_PERIPH_BASE + 0x12000)          /*!< (GPIO) Base Address */
/* PPI Interfaced IP */
#define UART0_BASE        (NUCLEI_SOC_PERIPH_BASE + 0x13000)          /*!< (UART0) Base Address */
#define QSPI0_BASE        (NUCLEI_SOC_PERIPH_BASE + 0x14000)          /*!< (QSPI0) Base Address */
#define PWM0_BASE         (NUCLEI_SOC_PERIPH_BASE + 0x15000)          /*!< (PWM0) Base Address */
#define UART1_BASE        (NUCLEI_SOC_PERIPH_BASE + 0x23000)          /*!< (UART1) Base Address */
#define QSPI1_BASE        (NUCLEI_SOC_PERIPH_BASE + 0x24000)          /*!< (QSPI1) Base Address */
#define PWM1_BASE         (NUCLEI_SOC_PERIPH_BASE + 0x25000)          /*!< (PWM1) Base Address */
#define QSPI2_BASE        (NUCLEI_SOC_PERIPH_BASE + 0x34000)          /*!< (QSPI2) Base Address */
#define PWM2_BASE         (NUCLEI_SOC_PERIPH_BASE + 0x35000)          /*!< (PWM2) Base Address */
#define I2C_BASE          (NUCLEI_SOC_PERIPH_BASE + 0x42000)          /*!< (I2C Master) Base Address */
