...
CHAR    *pointer;
    ...
    status =  tx_block_pool_create(&pool_3, "pool 3", 100, pointer, TEST_BLOCK_POOL_BYTES);
...
UINT    status;
    ...
    status =  tx_block_pool_create(&pool_3, "pool 3", 100, (void *) 0x100000, TEST_BLOCK_POOL_BYTES);
