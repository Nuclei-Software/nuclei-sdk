...
#define TEST_BYTE_POOL0_BYTES 160
#define TEST_BYTE_POOL4_BYTES 328
#else
#define TEST_BYTE_POOL0_BYTES 108
#define TEST_BYTE_POOL4_BYTES 300
#endif

#define TEST_BYTE_POOL_BLOCK_HEADER_BYTES ((ULONG) (sizeof(UCHAR *) + sizeof(ALIGN_TYPE)))
...
CHAR    *pointer;
    ...
    status =  tx_byte_pool_create(&pool_0, "pool 0", pointer, TEST_BYTE_POOL0_BYTES);
    pointer = pointer + TEST_BYTE_POOL0_BYTES;
    ...
    status =  tx_byte_pool_create(&pool_4, "pool 4", pointer, TEST_BYTE_POOL4_BYTES);
    pool_4_memory =  pointer;
    pointer = pointer + TEST_BYTE_POOL4_BYTES;
...
UCHAR   *save_search;
    ...
    status =  tx_byte_pool_create(TX_NULL, "pool 0", pointer_1, TEST_BYTE_POOL0_BYTES);
    ...
    status =  tx_byte_pool_create(&pool_0, "pool 0", pointer_1, TEST_BYTE_POOL0_BYTES);
    ...
    status =  tx_byte_pool_create(&pool_2, "pool 2", TX_NULL, TEST_BYTE_POOL0_BYTES);
    ...
    pool_0.tx_byte_pool_search =  TX_UCHAR_POINTER_SUB((UCHAR *) pointer_3, TEST_BYTE_POOL_BLOCK_HEADER_BYTES);
    ...
    /* Create pool 4.  */
    status =  tx_byte_pool_create(&pool_4, "pool 4", pool_4_memory, TEST_BYTE_POOL4_BYTES);
