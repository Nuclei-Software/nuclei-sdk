...
UINT    i;
    ...
    /* Temporary diagnostic: keep thread_31h aligned with the other priority-31
       threads to verify whether ERROR #31 is caused specifically by the
       preemption-threshold scheduling path.  */
