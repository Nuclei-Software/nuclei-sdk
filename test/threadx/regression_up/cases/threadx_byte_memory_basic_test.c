...
#define TEST_BYTE_POOL_HEADER_BYTES             (sizeof(UCHAR *) + sizeof(ALIGN_TYPE))
#define TEST_BYTE_POOL0_ALLOC_BYTES             24
#define TEST_BYTE_POOL0_BLOCK_COUNT             3
#define TEST_BYTE_POOL0_SIZE                    ((TEST_BYTE_POOL0_ALLOC_BYTES + TEST_BYTE_POOL_HEADER_BYTES) * TEST_BYTE_POOL0_BLOCK_COUNT + TEST_BYTE_POOL_HEADER_BYTES)
#define TEST_BYTE_POOL4_ALLOC_BYTES             84
#define TEST_BYTE_POOL4_BLOCK_COUNT             3
#define TEST_BYTE_POOL4_ALIGNED_ALLOC_BYTES     ((((TEST_BYTE_POOL4_ALLOC_BYTES) + sizeof(ALIGN_TYPE) - 1) / sizeof(ALIGN_TYPE)) * sizeof(ALIGN_TYPE))
#define TEST_BYTE_POOL4_SIZE                    ((TEST_BYTE_POOL4_ALIGNED_ALLOC_BYTES + TEST_BYTE_POOL_HEADER_BYTES) * TEST_BYTE_POOL4_BLOCK_COUNT + TEST_BYTE_POOL_HEADER_BYTES)
...
CHAR    *pointer;
    ...
    status =  tx_byte_pool_create(&pool_0, "pool 0", pointer, TEST_BYTE_POOL0_SIZE);
    pointer = pointer + TEST_BYTE_POOL0_SIZE;
    ...
    status =  tx_byte_pool_create(&pool_4, "pool 4", pointer, TEST_BYTE_POOL4_SIZE);
    pool_4_memory =  pointer;
    pointer = pointer + TEST_BYTE_POOL4_SIZE;
...
UCHAR   *save_search;
    ...
    status =  tx_byte_pool_create(TX_NULL, "pool 0", pointer_1, TEST_BYTE_POOL0_SIZE);
    ...
    status =  tx_byte_pool_create(&pool_0, "pool 0", pointer_1, TEST_BYTE_POOL0_SIZE);
    ...
    status =  tx_byte_pool_create(&pool_2, "pool 2", TX_NULL, TEST_BYTE_POOL0_SIZE);
    ...
    pool_0.tx_byte_pool_search =  TX_UCHAR_POINTER_SUB((UCHAR *) pointer_3, TEST_BYTE_POOL_HEADER_BYTES);
    ...
    /* Create pool 4.  */
    status =  tx_byte_pool_create(&pool_4, "pool 4", pool_4_memory, TEST_BYTE_POOL4_SIZE);
