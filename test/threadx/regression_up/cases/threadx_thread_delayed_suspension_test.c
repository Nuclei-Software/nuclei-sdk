...
static volatile UINT    delayed_suspend_set;

static volatile ULONG   thread_2_counter;
static volatile ULONG   thread_2_counter_capture;

static volatile ULONG   min_loop_count;
static volatile ULONG   max_loop_count;
static volatile ULONG   loop_count;
static volatile ULONG   count;
static volatile ULONG   destination =  0;
static ULONG            start_time;
static volatile ULONG   lower_bound;
static volatile ULONG   upper_bound;
static volatile ULONG   current_itterations;
#ifdef DEBUG_1
