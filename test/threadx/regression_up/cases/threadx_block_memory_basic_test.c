...
CHAR    *pointer;
    ...
    status =  tx_block_pool_create(&pool_3, "pool 3", TEST_BLOCK_MEMORY_PAYLOAD_SIZE, pointer, TEST_BLOCK_MEMORY_POOL_BYTES);
...
UINT    status;
    ...
    status =  tx_block_pool_create(&pool_3, "pool 3", TEST_BLOCK_MEMORY_PAYLOAD_SIZE, (void *) 0x100000, TEST_BLOCK_MEMORY_POOL_BYTES);
