...
// ref: https://github.com/Tencent/ncnn/blob/master/src/layer/riscv/rvv_mathfun.h
...
#define _RVV_FLOAT32_LOG_OP(LMUL, MLEN)                                                                                               \
    static inline vfloat32m##LMUL##_t log_ps_m##LMUL(vfloat32m##LMUL##_t x, size_t vl)                                                \
    {                                                                                                                                 \
...
#define _RVV_FLOAT32_EXP_OP(LMUL, MLEN)                                                                   \
    static inline vfloat32m##LMUL##_t exp_ps_m##LMUL(vfloat32m##LMUL##_t x, size_t vl)                    \
    {                                                                                                     \
...
#define _RVV_FLOAT32_SINCOS_OP(LMUL, MLEN)                                                                                                                  \
    static inline void sincos_ps_m##LMUL(vfloat32m##LMUL##_t x, vfloat32m##LMUL##_t* ysin, vfloat32m##LMUL##_t* ycos, size_t vl)                            \
    {                                                                                                                                                       \
        /* any x */                                                                                                                                         \
...
#define _RVV_FLOAT32_SIN_OP(LMUL, MLEN)                                                \
    static inline vfloat32m##LMUL##_t sin_ps_m##LMUL(vfloat32m##LMUL##_t x, size_t vl) \
    {                                                                                  \
        vfloat32m##LMUL##_t ysin, ycos;                                                \
        sincos_ps_m##LMUL(x, &ysin, &ycos, vl);                                        \
        return ysin;                                                                   \
    }
...
#define _RVV_FLOAT32_COS_OP(LMUL, MLEN)                                                \
    static inline vfloat32m##LMUL##_t cos_ps_m##LMUL(vfloat32m##LMUL##_t x, size_t vl) \
    {                                                                                  \
        vfloat32m##LMUL##_t ysin, ycos;                                                \
        sincos_ps_m##LMUL(x, &ysin, &ycos, vl);                                        \
        return ycos;                                                                   \
...
#define _RVV_FLOAT32_TANH_OP(LMUL, MLEN)                                                         \
    static inline vfloat32m##LMUL##_t tanh_ps_m##LMUL(vfloat32m##LMUL##_t x, size_t vl)          \
    {                                                                                            \
...
#define _RVV_FLOAT32_POW_OP(LMUL, MLEN)                                                               \
    static inline vfloat32m##LMUL##_t pow_ps_m##LMUL(vfloat32m##LMUL##_t a, vfloat32m##LMUL##_t b, size_t vl) \
    {                                                                                                 \
        /* pow(x, m) = exp(m * log(x)) */                                                             \
        return exp_ps_m##LMUL(__riscv_vfmul_vv_f32m##LMUL(b, log_ps_m##LMUL(a, vl), vl), vl);         \
    }
...
#define _RVV_FLOAT32_SIGMOID_OP(LMUL, MLEN)                                          \
    static inline vfloat32m##LMUL##_t sigmoid_ps_m##LMUL(vfloat32m##LMUL##_t _v, size_t vl)  \
    {                                                                                \
        _v = __riscv_vfneg_v_f32m##LMUL(_v, vl);                                     \
        _v = exp_ps_m##LMUL(_v, vl);                                                 \
...
#define _RVV_FLOAT32_ERFC_OP(LMUL, MLEN)                                                                                                                                                                                                                                                                                                                                                                   \
    static inline vfloat32m##LMUL##_t erfc_ps##LMUL(vfloat32m##LMUL##_t x, size_t vl)                                                                                                                                                                                                                                                                                                                      \
    {                                                                                                                                                                                                                                                                                                                                                                                                      \
        /* Argument for polys */                                                                                                                                                                                                                                                                                                                                                                           \
        ...
        vfloat32m##LMUL##_t z = __riscv_vreinterpret_v_u32m##LMUL##_f32m##LMUL(__riscv_vand_vx_u32m##LMUL(__riscv_vreinterpret_v_f32m##LMUL##_u32m##LMUL(absx), 0xfffff000, vl));                                                                                                                                                                                                                          \
                                                                                                                                                                                                                                                                                                                                                                                                           \
        vfloat32m##LMUL##_t r = __riscv_vfmul_vv_f32m##LMUL(exp_ps_m##LMUL(__riscv_vfmadd_vvf_f32m##LMUL(__riscv_vfneg_v_f32m##LMUL(z, vl), z, -0.5625f, vl), vl), exp_ps_m##LMUL(__riscv_vfmadd_vv_f32m##LMUL(__riscv_vfsub_vv_f32m##LMUL(z, absx, vl), __riscv_vfadd_vv_f32m##LMUL(z, absx, vl), q, vl), vl), vl);                                                                                       \
