...
// If you have auto generated cpu configuration files using nuclei_gen
#ifdef HAS_AUTOGEN_CPUCFG
// TODO: This autogen_nuclei_cpu.h is generated by nuclei_gen(the Nuclei CPU configure tool)
// If you are using future released nuclei_gen, you will be able to see a generated Nuclei SDK in the
// evaluation package, and you should use the generated Nuclei SDK not the opensource Nuclei SDK in github.
...
#if defined(HAS_AUTOGEN_CPUCFG) && defined(CFG_IRQ_NUM)
...
// TODO: If HAS_AUTOGEN_CPUCFG macro is defined, you can also use macros defined in autogen_nuclei_cpu.h
// No need to use this SystemIRegionInfo variable, you can directly set the __ECLIC_BASEADDR/__SYSTIMER_BASEADDR/__CIDU_BASEADDR
// using the value declared in autogen_nuclei_cpu.h
...
#if defined(HAS_AUTOGEN_CPUCFG) && defined(CFG_CLICINTCTLBITS)
#define __ECLIC_INTCTLBITS        CFG_CLICINTCTLBITS                     /*!< Set to 1 - 8, the number of hardware bits are actually implemented in the clicintctl registers. */
#else
...
#else
#define __ECLIC_INTNUM            CFG_IRQ_NUM + SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET   /*!< Set to 1 - 1024, total interrupt number of ECLIC Unit */
#endif
...
#define __SMPCC_PRESENT            0                     /*!< Set to 1 if SMPCC is present */
#define __SMPCC_BASEADDR          SystemIRegionInfo.smp_base              /*!< Set to smp and cluster cache baseaddr of your device */
...
#define __PMP_ENTRY_NUM           CFG_PMP_ENTRY_NUM     /*!< Set to 8 or 16, the number of PMP entries */
#else
...
#ifdef HAS_AUTOGEN_CPUCFG
#ifdef CFG_HAS_TEE
#define __TEE_PRESENT             1                     /*!< Set to 1 if TEE is present */
#define __SPMP_PRESENT            1                     /*!< Set to 1 if sPMP is present */
#define __SPMP_ENTRY_NUM          CFG_PMP_ENTRY_NUM     /*!< Set to 8 or 16, the number of sPMP entries */
#else
#define __TEE_PRESENT             0                     /*!< Set to 1 if TEE is present */
#define __SPMP_PRESENT            0                     /*!< Set to 1 if sPMP is present */
#define __SPMP_ENTRY_NUM          0                     /*!< Set to 8 or 16, the number of sPMP entries */
#endif
#else
#define __SPMP_PRESENT            1                     /*!< Set to 1 if sPMP is present */
