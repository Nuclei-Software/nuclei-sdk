...
#define GPIO_BASE               (EVALSOC_PERIPH_BASE + 0x12000)          /*!< (GPIO) Base Address */
/* PPI Interfaced IP */
...
#define PWM0_BASE               (EVALSOC_PERIPH_BASE + 0x15000)          /*!< (PWM0) Base Address */
...
#define PWM1_BASE               (EVALSOC_PERIPH_BASE + 0x25000)          /*!< (PWM1) Base Address */
#define QSPI2_BASE              (EVALSOC_PERIPH_BASE + 0x34000)          /*!< (QSPI2) Base Address */
#define PWM2_BASE               (EVALSOC_PERIPH_BASE + 0x35000)          /*!< (PWM2) Base Address */
#define I2C_BASE                (EVALSOC_PERIPH_BASE + 0x42000)          /*!< (I2C Master) Base Address */
