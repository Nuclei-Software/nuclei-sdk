...
// NOTE: Nuclei: first_unused_memory is not used here, since our port don't create a memory for you, you need
...
UINT    status;
    ...
    while(1)
    {
        ...
        printf("           thread 0 events sent           %10lu, thread 0 cpu %u\n", thread_0_counter  , thread_0.tx_thread_smp_core_mapped);
        printf("           thread 1 messages sent:        %10lu, thread 1 cpu %u\n", thread_1_counter  , thread_1.tx_thread_smp_core_mapped);
        printf("           thread 2 messages received:    %10lu, thread 2 cpu %u\n", thread_2_counter  , thread_2.tx_thread_smp_core_mapped);
        printf("           thread 3 obtained semaphore:   %10lu, thread 3 cpu %u\n", thread_3_counter  , thread_3.tx_thread_smp_core_mapped);
        printf("           thread 4 obtained semaphore:   %10lu, thread 4 cpu %u\n", thread_4_counter  , thread_4.tx_thread_smp_core_mapped);
        printf("           thread 5 events received:      %10lu, thread 5 cpu %u\n", thread_5_counter  , thread_5.tx_thread_smp_core_mapped);
        printf("           thread 6 mutex obtained:       %10lu, thread 6 cpu %u\n", thread_6_counter  , thread_6.tx_thread_smp_core_mapped);
        printf("           thread 7 mutex obtained:       %10lu, thread 7 cpu %u\n\n", thread_7_counter, thread_7.tx_thread_smp_core_mapped);
