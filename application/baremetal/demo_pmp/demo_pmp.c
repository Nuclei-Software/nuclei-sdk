...
{
    printf("----protected_execute success!----\r\n");
...
int main(void)
{
    ...
    memset(&pmp_config_x, 0, sizeof(pmp_configs));
    ...
    /* Verify the configuration takes effect */
    memset(&pmp_config_rw, 0, sizeof(pmp_configs));
